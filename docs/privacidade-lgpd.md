...
SEFAZ AM: Cadastro de Veículo (Outra UF) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_am_cadastro_veiculo@mcp.ai](mailto:sefaz_am_cadastro_veiculo@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
